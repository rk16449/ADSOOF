...
class TopView {
    ...
    /*
     * Author credit to - Talluri Mithra
     */
    public static void topView(Node root) {
        // took a queue - similar to BFS approach
        Queue<QueueNode> queue = new LinkedList<QueueNode>();

        // why TreeMap? Because I want the values to be sorted from leftmost to
        // rightmost nodes
        // Eg: TreeMap<first, second>
        ...
        while (!queue.isEmpty()) {
            ...
            // if the level of this node has never been reached before -> visible in top
            // view
